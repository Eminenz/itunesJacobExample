...
public class IITUserPlaylist extends Dispatch {
	...
	*/
	 ...
	 */
	public IITOperationStatus addFile(String filePath) {
		return new IITOperationStatus(Dispatch.call(this, "AddFile", filePath).toDispatch());
	}
	 ...
	 * @return the result is of type IITOperationStatus
	 */
	public IITOperationStatus addFiles(Variant filePaths) {
		return new IITOperationStatus(Dispatch.call(this, "AddFiles", filePaths).toDispatch());
	}
	 ...
	 */
	public IITURLTrack addURL(String uRL) {
		return new IITURLTrack(Dispatch.call(this, "AddURL", uRL).toDispatch());
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param iTrackToAdd an input-parameter of type Variant
	 * @return the result is of type IITTrack
	 */
	public IITTrack addTrack(Variant iTrackToAdd) {
		return new IITTrack(Dispatch.call(this, "AddTrack", iTrackToAdd).toDispatch());
	}
	...
	public boolean getShared() {
		return Dispatch.get(this, "Shared").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param shared an input-parameter of type boolean
	 */
	public void setShared(boolean shared) {
		Dispatch.put(this, "Shared", new Variant(shared));
	}
	...
	public boolean getSmart() {
		return Dispatch.get(this, "Smart").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @return the result is of type ITUserPlaylistSpecialKind
	 */
	public ITUserPlaylistSpecialKind getSpecialKind() {
		return ITUserPlaylistSpecialKind.values()[Dispatch.get(this, "SpecialKind").getInt()];
	}
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param parent an input-parameter of type Variant
	 */
	public void setParent(Variant parent) {
		Dispatch.put(this, "Parent", parent);
	}
