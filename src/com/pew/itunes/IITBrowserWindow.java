...
public class IITBrowserWindow extends Dispatch {
	...
	*/
	...
	public boolean getMiniPlayer() {
		return Dispatch.get(this, "MiniPlayer").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param miniPlayer an input-parameter of type boolean
	 */
	public void setMiniPlayer(boolean miniPlayer) {
		Dispatch.put(this, "MiniPlayer", new Variant(miniPlayer));
	}
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param selectedPlaylist an input-parameter of type Variant
	 */
	public void setSelectedPlaylist(Variant selectedPlaylist) {
		Dispatch.put(this, "SelectedPlaylist", selectedPlaylist);
	}
